...
export default function Events() {
  ...
  const events = [
    { id: 1, day: '23', month: 'Mar', year: '2026', name: 'Hackathon 2026 — Semicolon', club: 'IEEE Club', venue: 'Main Auditorium', tag: 'Tech', tagColor: '#6c63ff', tagBg: 'rgba(108,99,255,0.15)', rsvpCount: 142, desc: 'A 24-hour hackathon for students to build innovative solutions.', emoji: '💻' },
    { id: 2, day: '19', month: 'Mar', year: '2026', name: 'Cultural Fest — Aarohan', club: 'Cultural Club', venue: 'Mini Hall - 1', tag: 'Cultural', tagColor: '#f7c948', tagBg: 'rgba(247,201,72,0.15)', rsvpCount: 380, desc: 'Annual cultural extravaganza with dance, music and art.', emoji: '🎭' },
    { id: 3, day: '20', month: 'Mar', year: '2026', name: 'Web Dev Workshop', club: 'IEEE Club', venue: 'J.C. Bose Hall', tag: 'Workshop', tagColor: '#00d2ff', tagBg: 'rgba(0,210,255,0.15)', rsvpCount: 89, desc: 'Hands-on workshop on modern web development with Next.js.', emoji: '🌐' },
    { id: 4, day: '24', month: 'Mar', year: '2026', name: 'Sports Meet — Invictus', club: 'Sports Club', venue: 'Faraday Hall', tag: 'Sports', tagColor: '#43e97b', tagBg: 'rgba(67,233,123,0.15)', rsvpCount: 210, desc: 'Inter-department sports competition with multiple events.', emoji: '⚽' },
